...
public class Game  implements Parcelable {
    ...
    /***
     * returns 0 if it's a standard parcel, else if sending files need to return file descriptor
     * @return
     */
    @Override
    ...
    /***
     * Writes aa the member variables to the classof the parcel
    ...
    // In order to read Parcel we need a CREATOR
